...
- Executer le code plot_dump pour créer les audio en .wav et visualiser les signaux. Pour cela, il faut se placer dans le repertoire qui contient rtaudio-6.0.1. 